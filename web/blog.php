				...
				<div>
					<ul>
						<li>
							...
							<h1><a href="index.php">Newest Recipe with a Twist</a></h1>
						...
						<li>
							...
							<h1><a href="index.php">Christmas is coming!</a></h1>
							<h2>Christmas Products on the go...</h2>
					...
					<div class="section">
						<a href="index.php" class="newerpost">Newer Post</a>
						<a href="index.php">Home</a>
						<a href="index.php" class="olderpost">Older Post</a>
					</div>
				</div>
			</div>
		</div>
